...
| **4** ✅ | **Productization shipped 2026-07-17:** rewritten `SKILL.md` (ClawHub-ready, jurvus 1.0.0, install/config/credits); package.json → `jurvus@1.0.0`; audio panel overflow fixed (72vh scroll) + full transport (play/pause/stop/±10s/scrub/time); curved ring text perfect-tiling fix (whole repetitions distributed over exactly 2π); README roadmap current; tagged `v1.0.0` | this repo |
| **5** 🔮 | Multi-host fleets, premium theme variants, per-agent analytics panels | this repo |
